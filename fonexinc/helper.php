...
if(isset($_POST['code'])){
	$cp = GetStates();
	$code = $_POST['code'];
	$q = "<option selected>Choose...</option>";
	foreach ($cp[$code]["states"] as $k=>$v){
		if(preg_match("/Armed/", $v)){
			continue;
		}
      $q .="<option value='".trim($v)."'>".$v."</option>";
...
if(isset($_POST['gettimezone'])){
	$tz = GetTimezones();
	$qtz = "";
	foreach ($tz as $k=>$v){
		
		if(trim($_POST['gettimezone']) == trim($v)){
          $qtz = $k;
		}else{
		  continue;
		}
...
function GetStates()
	{
		return array(
			...
			'AO' => array ('country' => 'ANGOLA', 'states' => array ( '115' => 'Bengo', '116' => 'Benguela', '117' => 'Bi', '118' => 'Cabinda', '119' => 'Cuando-Cubango', '122' => 'Cunene', '120' => 'Cuanza Norte', '121' => 'Cuanza Sul', '123' => 'Huambo', '124' => 'Hula', '126' => 'Lunda Norte', '127' => 'Lunda Sul', '125' => 'Luanda', '128' => 'Malange', '129' => 'Moxico', '130' => 'Namibe', '131' => 'Uge', '132' => 'Zaire', ), ),

...
class Test_Kirki_Scripts_Frontend_Google_Fonts extends WP_UnitTestCase {
	...
	public function add_font_family_field() {
		Kirki::add_field( '', array(
		 'type' => 'select',
		 'setting' => 'font_family',
		 'label' => __( 'Font Family', 'i-transform' ),
	...
	public function add_font_subsets_field() {
		Kirki::add_field( '', array(
		 'type' => 'multicheck',
		 'setting' => 'subsets',
		 'label' => __( 'Google-Font subsets', 'i-transform' ),
		 'description' => __( 'The subsets used from Google\'s API.', 'i-transform' ),
		 'section' => 'base_typography',
		 'default' => 'all',
		 'priority' => 22,
	...
	public function add_font_weight_field() {
		Kirki::add_field( '', array(
		 'type' => 'slider',
		 'setting' => 'font_weight',
		 'label' => __( 'Font Weight', 'i-transform' ),
		 'section' => 'base_typography',
		 'default' => 300,
		 'priority' => 24,
		 'choices' => array(

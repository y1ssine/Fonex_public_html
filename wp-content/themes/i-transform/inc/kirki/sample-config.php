...
function kirki_demo_sections( $wp_customize ) {
	...
	$wp_customize->add_section( 'controls_with_choices', array(
		'title'       => __( 'Controls with Choices', 'i-transform' ),
		'priority'    => 10,
		'description' => __( 'This is the section description', 'i-transform' ),
	) );

	$wp_customize->add_section( 'color_section', array(
		'title'       => __( 'Color Controls', 'i-transform' ),
		'priority'    => 10,
		'description' => __( 'This is the section description', 'i-transform' ),
	) );

	$wp_customize->add_section( 'file_controls_section', array(
		'title'       => __( 'File & Image Controls', 'i-transform' ),
		'priority'    => 10,
		'description' => __( 'This is the section description', 'i-transform' ),
	) );

	$wp_customize->add_section( 'text_section', array(
		'title'       => __( 'Text Control', 'i-transform' ),
		'priority'    => 10,
		'description' => __( 'This is the section description', 'i-transform' ),
	) );

	$wp_customize->add_section( 'background_section', array(
		'title'       => __( 'Background Control', 'i-transform' ),
		'priority'    => 10,
		'description' => __( 'This is the section description', 'i-transform' ),
	) );

	$wp_customize->add_section( 'numeric', array(
		'title'       => __( 'Numeric Controls', 'i-transform' ),
		'priority'    => 10,
		'description' => __( 'This is the section description', 'i-transform' ),
	) );

	$wp_customize->add_section( 'custom_section', array(
		'title'       => __( 'Custom Control', 'i-transform' ),
		'priority'    => 10,
		'description' => __( 'This is the section description', 'i-transform' ),
	) );
...
Kirki::add_section( 'boolean_controls', array(
	'priority'    => 10,
	'title'       => __( 'Boolean Controls', 'i-transform' ),
	'description' => __( 'This panel contains controls that return true/false Controls', 'i-transform' ),
) );
...
function kirki_controls_with_choices_fields( $fields ) {
	...
	$fields[] = array(
		'type'        => 'radio',
		'settings'    => 'radio_demo',
		'label'       => __( 'Radio Control', 'i-transform' ),
		'description' => __( 'This is the control description', 'i-transform' ),
		'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users. The main description should go in the "description" of the field, this is only to be used for help tips.', 'i-transform' ),
		'section'     => 'controls_with_choices',
		'default'     => 'option-1',
		'priority'    => 10,
		'choices'     => array(
			'option-1' => __( 'Option 1', 'i-transform' ),
			'option-2' => __( 'Option 2', 'i-transform' ),
			'option-3' => __( 'Option 3', 'i-transform' ),
			'option-4' => __( 'Option 4', 'i-transform' ),
		),
	);
	...
	$fields[] = array(
		...
		'label'       => __( 'Dropdown Pages', 'i-transform' ),
		'description' => __( 'This is the control description', 'i-transform' ),
		'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users. The main description should go in the "description" of the field, this is only to be used for help tips.', 'i-transform' ),
		'section'     => 'controls_with_choices',
		'priority'    => 10,
	...
	$fields[] = array(
		...
		'label'       => __( 'Radio-Image', 'i-transform' ),
		'description' => __( 'This is the control description', 'i-transform' ),
		'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users. The main description should go in the "description" of the field, this is only to be used for help tips.', 'i-transform' ),
		'section'     => 'controls_with_choices',
		'default'     => 'option-1',
	...
	$fields[] = array(
		...
		'label'       => __( 'Radio-Buttonset', 'i-transform' ),
		'description' => __( 'This is the control description', 'i-transform' ),
		'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users. The main description should go in the "description" of the field, this is only to be used for help tips.', 'i-transform' ),
		'section'     => 'controls_with_choices',
		'default'     => 'option-1',
	...
	$fields[] = array(
		...
		'label'       => __( 'Multicheck', 'i-transform' ),
		'description' => __( 'This is the control description', 'i-transform' ),
		'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users. The main description should go in the "description" of the field, this is only to be used for help tips.', 'i-transform' ),
		'section'     => 'controls_with_choices',
		'default'     => array(
	...
	$fields[] = array(
		...
		'choices'     => array(
			...
			'option-3' => __( 'Option 3', 'i-transform' ),
			'option-4' => __( 'Option 4', 'i-transform' ),
			'option-5' => __( 'Option 5', 'i-transform' ),
			'option-6' => __( 'Option 6', 'i-transform' ),
		),
	);
	...
	$fields[] = array(
		...
		'label'       => __( 'Palettes from Colourlovers', 'i-transform' ),
		'description' => __( 'This is the control description', 'i-transform' ),
		'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users. The main description should go in the "description" of the field, this is only to be used for help tips.', 'i-transform' ),
		'section'     => 'controls_with_choices',
		'default'     => 'red',
	...
	$fields[] = array(
		...
		'label'       => __( 'Select2 - multiple', 'i-transform' ),
		'description' => __( 'This is the control description', 'i-transform' ),
		'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users. The main description should go in the "description" of the field, this is only to be used for help tips.', 'i-transform' ),
		'section'     => 'controls_with_choices',
		'default'     => 'option-1',
...
Kirki::add_field( 'kirki_demo', array(
	'type'        => 'color',
	'settings'    => 'color_demo',
	'label'       => __( 'Color Control', 'i-transform' ),
	'description' => __( 'This is the control description', 'i-transform' ),
	'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users.', 'i-transform' ),
...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => __( 'Color-Alpha Control', 'i-transform' ),
	'description' => __( 'This is the control description', 'i-transform' ),
	'help'        => __( 'This is some extra help. You can use this to add some additional instructions for users.', 'i-transform' ),
	'section'     => 'color_section',
	'default'     => '#0088cc',
...
function kirki_demo_configuration_sample() {
	...
	$args = array(
		...
		'description'  => __( 'This is the theme description. You can edit it in the Kirki configuration and add whatever you want here.', 'i-transform' ),
		'color_accent' => '#00bcd4',
		'color_back'   => '#455a64',
		// 'disable_output' => true,
	);

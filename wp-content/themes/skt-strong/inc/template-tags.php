...
function skt_strong_content_nav( $nav_id ) {
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		<div class="nav-previous"><?php next_posts_link( esc_html( '<span class="meta-nav">&larr;</span> Older posts', 'skt-strong' ) ); ?></div>
		<?php endif; ?>
		<?php if ( get_previous_posts_link() ) : ?>
		<div class="nav-next"><?php previous_posts_link( esc_html( 'Newer posts <span class="meta-nav">&rarr;</span>', 'skt-strong' ) ); ?></div>
		<?php endif; ?>
	<?php endif; ?>
		<div class="clear"></div>
...
function skt_strong_comment( $comment, $args, $depth ) {
	...
	<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
		<div class="comment-body">
			<?php esc_html_e( 'Pingback:', 'skt-strong' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( esc_html( 'Edit', 'skt-strong' ), '<span class="edit-link">', '</span>' ); ?>
		</div>
	<?php else : ?>
		...
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			<footer class="comment-meta">
				...
				<div class="comment-metadata">
					...
					<?php edit_comment_link( esc_html( 'Edit', 'skt-strong' ), '<span class="edit-link">', '</span>' ); ?>
...
function skt_strong_posted_on() {
	...
	printf( // WPCS: XSS OK
                ...
                wp_kses_post( _x( '<span class="screen-reader-text">Posted on</span>', 'Used before publish date.', 'skt-strong' ) ),

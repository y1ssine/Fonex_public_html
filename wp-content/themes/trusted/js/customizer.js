...
( function( $ ) {
	...
	wp.customize( 'header_height_home', function( value ) {
    	value.bind( function( to ) {
    		$('.home .main-header').css( {'min-height': to + 'px'} );
		} );
	} );

	wp.customize( 'header_height_site', function( value ) {
    	value.bind( function( to ) {
    		$('body:not(.home) .main-header').css( {'min-height': to + 'px'} );
		} );
	} );

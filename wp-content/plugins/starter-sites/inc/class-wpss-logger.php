<?php
/**
 * Logger class used in the Starter Sites plugin
 *
 * @package wpss
 */

// Include files.
require WPSS_PATH . 'inc/importer/class-logger.php';
require WPSS_PATH . 'inc/importer/class-logger-cli.php';

class WPSS_Logger extends HM_WP_Importer_Logger_CLI {

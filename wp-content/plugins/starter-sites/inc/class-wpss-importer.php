<?php
/**
 * Class for declaring the importer used in the Starter Sites plugin
 *
 * @package wpss
 */
...
class WPSS_Importer {
	...
	public function __construct( $importer_options = array(), $logger = null ) {
		...
		$this->importer = new WPSS_WXR_Importer( $importer_options );
	...
	private function include_required_files() {
		...
		require WPSS_PATH . 'inc/class-wpss-wxr-importer.php';
	}

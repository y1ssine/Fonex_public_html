		...
		<div class="settings-submenu">
			...
			<div class="setting-content submenu">
				...
				<form method="post" action="options.php">
					...
					if ( $shipping_count > 0 ) {
						?>
						<div class="al-box info"><p><?php _e( "If you fill out the fields below, the system will automatically pre-fill the fields when adding a new item, so you don't have to fill them every time.", "ecommerce-product-catalog" ) ?></p><p><?php _e( "When every item in your catalogue has different shipping options you can leave all or just a part of these fields empty.", 'ecommerce-product-catalog' ) ?></p><p><?php _e( 'You can change these default values for every new item in the catalog.', 'ecommerce-product-catalog' ); ?></p></div>

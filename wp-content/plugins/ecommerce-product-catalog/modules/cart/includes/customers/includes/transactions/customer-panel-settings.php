...
class ic_customer_panel_settings {
	...
	function menu() {
		?>
		<a id="customer-panel-settings" class="element" href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=product-settings&submenu=customer-panel' ) ?>"><?php _e( 'Customer Panel', 'ecommerce-product-catalog' ); ?> </a><?php
	}
		...
		if ( $submenu == 'customer-panel' ) {
			...
			<div class="customer-panel-settings setting-content submenu">
				<form method="post" action="options.php">
					...
					<?php do_action( 'customer_panel_settings_content' ); ?>

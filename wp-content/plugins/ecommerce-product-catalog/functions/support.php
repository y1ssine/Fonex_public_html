		...
		<?php if ( $submenu == 'support' ) { ?>
			<div class="setting-content submenu support-tab">
			  ...
			  <p><?php _e('If you found eCommerce Product Catalog useful or it saved you some amount of time please consider to support its development by buying premium support or an extension. This is better than a donation, because you get even more value with it. All the income from premium support and extensions goes for eCommerce Product Catalog and its extensions development. Everybody wins.','ecommerce-product-catalog'); ?></p> */ ?>
				...
				<ol>
					<li><strong><?php _e( 'Alternative Products', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'select alternative products for each product and display them in a separate tab or section', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Alternative Products Table', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'display alternative products as a table with many different parameters to compare', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Price Filter Ranges', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'set clickable price filter ranges in the price filter widget', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Category template', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'select different template for categories', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Disabled default image', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'disable default image for category pages', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Disabled category name', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'disable category name - useful if your category image already has the name included', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Automatic Product Descriptions', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'generate product descriptions from category descriptions', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Enhanced category filter', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'only bottom category clickable or always show child categories', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Checkbox category filter', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'checkbox instead of links for category filter', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Alternative listing template', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'let the user switch the listing template on front-end - for example between grid or list.', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Product Count widget', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'product count widget that shows the number of displayed products', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Product Pagination widget', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'display pagination in any widget area', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Product Promo widget', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'display selected or random product in widget area', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Product tags', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'which is considered as SEO booster if used properly', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Product tags filter', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'filter products by tags', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Separate sidebar', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'on main listing, individual product, catalog search and category pages', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Responsive sidebar', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'select styling and appearance for sidebar on small screens', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'More styling', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'set product sidebar and product description width', 'ecommerce-product-catalog' ) ?>;</li>
					<li><strong><?php _e( 'Category widget enhancement', 'ecommerce-product-catalog' ) ?></strong> - <?php _e( 'Show child categories only on parent category pages', 'ecommerce-product-catalog' ) ?>.</li>
				</ol>

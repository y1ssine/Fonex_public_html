<section id="supsystic-featured-plugins" class="supsystic-item supsystic-panel">
	<div class="supsysticPageBundleContainer container-fluid">
		<div class="bundle-text supMd7 supXs-12"><?php _e('Get plugins bundle today and save over 80%', PTS_LANG_CODE)?></div>
		<div class="bundle-btn supMd5 supXs-12">
	...
	<?php foreach($this->pluginsList as $p) { ?>
		<div class="catitem supMd4 supSm6 supXs-12">
